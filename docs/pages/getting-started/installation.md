...
<!-- prettier-ignore -->
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/themes/viur.css" />
<script type="module" src="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/shoelace-autoloader.js"></script>
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/themes/viur.css" />
<script type="module" src="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/shoelace.js"></script>
```
...
<!-- prettier-ignore -->
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/themes/viur_dark.css" />
```
...
<link
  ...
  href="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/themes/viur.css"
/>
<link
  rel="stylesheet"
  media="(prefers-color-scheme:dark)"
  href="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/themes/viur_dark.css"
...
<script type="module">
  import { setBasePath } from '@viur/viur-shoelace/%NPMDIR%/utilities/base-path.js';
...
<script type="module" data-shoelace="/path/to/shoelace/%NPMDIR%">
  import '@viur/viur-shoelace/%NPMDIR%/components/button/button.js';
...
```js
import '@viur/viur-shoelace/%NPMDIR%/themes/viur.css';
import '@viur/viur-shoelace/%NPMDIR%/components/button/button.js';
import '@viur/viur-shoelace/%NPMDIR%/components/icon/icon.js';
import '@viur/viur-shoelace/%NPMDIR%/components/input/input.js';
import '@viur/viur-shoelace/%NPMDIR%/components/rating/rating.js';
import { setBasePath } from '@viur/viur-shoelace/%NPMDIR%/utilities/base-path.js';
...
:::warning
Component modules include side effects for registration purposes. Because of this, importing directly from `@viur/viur-shoelace` may result in a larger bundle size than necessary. For optimal tree shaking, always cherry pick, i.e. import components and utilities from their respective files, as shown above.
:::
