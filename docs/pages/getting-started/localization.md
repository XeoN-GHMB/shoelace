...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/@viur/shoelace?path=%CDNDIR%%2Ftranslations)
- If you're using a bundler, import them from `@viur/shoelace/%NPMDIR%/translations/[lang].js`
...
```js
import { registerTranslation } from '@viur/shoelace/dist/utilities/localize';
import type { Translation } from '@viur/shoelace/dist/utilities/localize';
