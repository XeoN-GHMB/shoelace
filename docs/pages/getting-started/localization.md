...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/@viur/viur-shoelace?path=%CDNDIR%%2Ftranslations)
- If you're using a bundler, import them from `@viur/viur-shoelace/%NPMDIR%/translations/[lang].js`
...
```js
import { registerTranslation } from '@viur/viur-shoelace/dist/utilities/localize';
import type { Translation } from '@viur/viur-shoelace/dist/utilities/localize';
