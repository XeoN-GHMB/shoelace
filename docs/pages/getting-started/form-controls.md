...
```js
import { serialize } from '@viur/shoelace/dist/utilities/form.js';
...
```jsx:react
import SlButton from '@viur/shoelace/dist/react/button';
import SlCheckbox from '@viur/shoelace/dist/react/checkbox';
import SlInput from '@viur/shoelace/dist/react/input';
import SlMenuItem from '@viur/shoelace/dist/react/menu-item';
import SlSelect from '@viur/shoelace/dist/react/select';
import SlTextarea from '@viur/shoelace/dist/react/textarea';
...
```js
import { getFormControls } from '@viur/shoelace/dist/utilities/form.js';
