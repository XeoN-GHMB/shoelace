...
```js
import { setDefaultAnimation } from '@viur/shoelace/dist/utilities/animation-registry.js';
...
```js
import { setAnimation } from '@viur/shoelace/dist/utilities/animation-registry.js';
