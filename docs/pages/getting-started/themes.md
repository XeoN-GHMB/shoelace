...
<html class="sl-theme-viur_dark">
  <head>
    <link rel="stylesheet" href="path/to/shoelace/%NPMDIR%/themes/viur_dark.css" />
  </head>
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@%VERSION%/%CDNDIR%/themes/dark.css">
```
