      ...
      content = content.replace(/\[component-metadata:([a-z-]+)\]/g, (match, tag) => {
        ...
        if (component.path) {
          ...
          result += `
            ...
            \`\`\`html
            <script type="module" src="https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@${metadata.package.version}/dist/${component.path}"></script>
            \`\`\`
            </sl-tab-panel>
            ...
            \`\`\`js
            import 'https://cdn.jsdelivr.net/npm/@viur/viur-shoelace@${metadata.package.version}/dist/${component.path}';
            \`\`\`
            </sl-tab-panel>
            ...
            \`\`\`js
            import '@viur/viur-shoelace/dist/${component.path}';
            \`\`\`
            </sl-tab-panel>
