(() => {
  function convertModuleLinks(html) {
    html = html
      .replace(/@shoelace-style\/shoelace/g, `https://esm.sh/@viur/shoelace@${shoelaceVersion}`)
  ...
  document.addEventListener('click', event => {
    ...
    if (button?.classList.contains('code-preview__button--codepen')) {
      ...
      const theme = document.documentElement.classList.contains('sl-theme-viur-dark') ? 'dark' : 'light';
      ...
      if (!isReact) {
        htmlTemplate =
          `<script type="module" src="https://cdn.jsdelivr.net/npm/@viur/shoelace@${shoelaceVersion}/${cdndir}/shoelace.js"></script>\n` +
          `\n${htmlExample}`;
        jsTemplate = '';
      }
      ...
      if (isReact) {
        ...
        jsTemplate =
          ...
          `import { setBasePath } from 'https://esm.sh/@viur/shoelace@${shoelaceVersion}/${cdndir}/utilities/base-path';\n` +
          `\n` +
          `// Set the base path for Shoelace assets\n` +
          `setBasePath('https://esm.sh/@viur/shoelace@${shoelaceVersion}/${npmdir}/')\n` +
      ...
      // CSS templates
      cssTemplate =
        `@import 'https://cdn.jsdelivr.net/npm/@viur/shoelace@${shoelaceVersion}/${cdndir}/themes/${
          isDark ? 'dark' : 'light'
        }.css';\n` +
        '\n' +
        'body {\n' +
      ...
      const data = {
        ...
        html_classes: `sl-theme-${isDark ? 'sl-theme-viur-dark' : 'viur'}`,
        css_external: ``,
        js_external: ``,
        js_module: true,
