...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/@viur/viur-shoelace?path=dist%2Ftranslations)
- If you're using a bundler, import them from `@viur/viur-shoelace/dist/translations/[lang].js`
