...
```js
import { setDefaultAnimation } from '@viur/viur-shoelace/dist/utilities/animation-registry.js';
...
```js
import { setAnimation } from '@viur/viur-shoelace/dist/utilities/animation-registry.js';
